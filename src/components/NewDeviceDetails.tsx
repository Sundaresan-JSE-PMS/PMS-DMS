...
export const NewDeviceDetails: FC<DeviceDetails> = (props): JSX.Element => {
    ...
    const [newalarm, setNewAlarm] = useState<
        Array<{
            date: string;
            time: { val: string; alarm: string[]; priority: string[] };
        }>
    >([]);
    const leftarrowcolor = selectAlarm == 0 ? "#606060" : "white";
    const rightarrowcolor =
        selectAlarm == newalarm.length - 1 ? "#606060" : "white";
        ...
        if (newalarm[selectAlarm].time.priority[index] == "High Priority") {
            return (
                <Box
                    ...
                    textAlign={"center"}
                >
                    <Typography variant="subtitle1" paddingTop={"13%"}>
                        <b>{vals}</b>
                    </Typography>
                    <div
                        style={{
                    ...
                    >
                        <Typography variant="subtitle2">
                            {newalarm[selectAlarm].date.toString()} -{" "}
                            {newalarm[selectAlarm].time.val.toString()}
                        </Typography>
                    </div>
                </Box>
            );
            ...
            return (
                <Box
                    ...
                    sx={{
                        ...
                        borderRadius: "10px",
                        margin: "15px",
                        boxShadow: `0px 0px 10px 1px #ffd700`,
                    }}
                    justifyContent={"center"}
                    textAlign={"center"}
                >
            ...
            return (
                <Box
                    ...
                    sx={{
                        ...
                        borderRadius: "10px",
                        margin: "15px",
                        boxShadow: `0px 0px 10px 1px cyan`,
                    }}
                    justifyContent={"center"}
                    textAlign={"center"}
                >
    ...
    const [rows, setRows] = useState<
        Array<{ date: string; time: string; alarm: string[][] }>
    >([]);
    ...
    const infscrollfunc = (page: Number) => {
        fetch(
            `https://pmsind.co.in:5000/Communication/${props.communication_resource.id}/_history/?_page=${page}`,
            {
                ...
                data.entry.map((commres: any) => {
                    if (commres.resource.extension) {
                        const lastUpdatedDate = new Date(
                            commres.resource.meta.lastUpdated.toString()
                        );
                        var xx: string[][] = [];
                        commres.resource.extension[0].valueCodeableConcept.coding.map(
                            (
                                val: { display: { toString: () => string } },
                                index: string | number
                            ) => {
                                xx.push([
                                    val.display.toString(),
                                    commres.resource.extension[1].valueCodeableConcept.coding[
                                        index
                                    ].display.toString(),
                                ]);
                            }
                    ...
                    li.onclick = () => {
                        ...
                        if (type === "pie" || type === "doughnut") {
                            ...
                            if (item.datasetIndex !== undefined) {
                                ...
                                chart.isDatasetVisible(item.datasetIndex)
                                    ? setSelectedLegends((prev: any) => [
                                          ...prev,
                                          item.text,
                                      ])
                                    : setSelectedLegends((current: any[]) =>
                                          current.filter(
                                              (lol) => lol !== item.text
                                          )
                                      );
    ...
    const handleExportData = () => {
        if (temperatureData.labels.length != 0 && selectedLegends.length != 0) {
            ...
            selectedLegends.map((item: any) => {
                temperatureData.datasets.map(
                    (val: { data: any; label: any }) => {
                        if (val.label == item) {
                            vvtemp.push(val.data);
                        }
                    }
                );
                pulseoximeterData.datasets.map(
                    (val: { data: any; label: any }) => {
                        if (val.label == item) {
                            vvtemp.push(val.data);
                        }
            ...
            let temprow = [];
            temprow.push(
                selectedLegends.map((vals: any, index: number) => {
                    return {
                        Parameter: vals,
                        Values: vvtemp[index],
                    };
    ...
    useEffect(() => {
        if (props.communication_resource?.id != null) {
            fetch(
                `https://pmsind.co.in:5000/Communication/${props.communication_resource.id}/_history/`,
                {
                    credentials: "omit",
                    headers: {
                        Authorization:
                            "Basic " + btoa("fhiruser:change-password"),
                    },
                }
            )
                .then((response) => response.json())
        ...
        communication.map((commres) => {
            if (commres.resource.extension) {
                ...
                y.push({
                    ...
                    time: {
                        val: lastUpdatedDate.toLocaleTimeString(),
                        alarm: commres.resource.extension[0].valueCodeableConcept.coding.map(
                            (val) => {
                                return val.display.toString();
                            }
                        ),
                        priority:
                            commres.resource.extension[1].valueCodeableConcept.coding.map(
                                (val) => {
                                    return val.display.toString();
                                }
                            ),
    ...
    useEffect(() => {
        if (props.communication_resource?.id != null) {
            ...
            if (props.communication_resource.extension) {
                const lastUpdatedDate = new Date(
                    props.communication_resource.meta.lastUpdated
                );
                ...
                y.push({
                    ...
                    time: {
                        val: lastUpdatedDate.toLocaleTimeString(),
                        alarm: props.communication_resource.extension[0].valueCodeableConcept.coding.map(
                            (val) => {
                                return val.display.toString();
                            }
                        ),
                        priority:
                            props.communication_resource.extension[1].valueCodeableConcept.coding.map(
                                (val) => {
                                    return val.display.toString();
                                }
                            ),
                ...
                var xx: string[][] = [];
                props.communication_resource.extension[0].valueCodeableConcept.coding.map(
                    (val, index) => {
                        xx.push([
                            val.display.toString(),
                            props.communication_resource.extension[1].valueCodeableConcept.coding[
                                index
                            ].display.toString(),
                        ]);
                    }
    ...
    function getDataForGraph(page: number, when: string) {
        ...
        function fetchData(when: string, times: number): Promise<void> {
            return fetch(
                `https://pmsind.co.in:5000/Observation/${props.observation_resource.id}/_history?_count=1&_since=${when}&_page=${page}`,
                {
                    credentials: "omit",
                    method: "GET",
                    headers: {
                ...
                .then((data: any) => {
                    if (data.total > 0) {
                        var lastpage =
                            Math.floor(data.total / 10) + (data.total % 10);
                        return fetch(
                            `https://pmsind.co.in:5000/Observation/${props.observation_resource.id}/_history?_count=1&_since=${when}&_page=${lastpage}`,
                            {
                                credentials: "omit",
                                method: "GET",
                                headers: {
                            ...
                            .then((data: any) => {
                                if (
                                    data.entry[0].resource.meta.versionId !=
                                    meta
                                ) {
                                    meta =
                                        data.entry[0].resource.meta.versionId;
                                ...
                                if (timeFrame == 1 ? times < 7 : times < 14) {
                                    const newWhen = subtractDaysFromDate(
                                        when,
                                        1
                                    );
    ...
    useEffect(() => {
        ...
        let currentmonth = (Number(currentNewDate.getMonth()) + 1)
            .toString()
            .padStart(2, "0");
        ...
        if (timeFrame != -1) {
            if (timeFrame == 0) {
                let prevdate = "";
                url.push(
                    `https://pmsind.co.in:5000/Observation/${props.observation_resource?.id}/_history?_since=${currentDate}T00:00:00Z&_count=10000`
                );
                Promise.all(
                    url.map((query) => {
                        return fetch(query, {
                            ...
                            .then((data) => {
                                ...
                                if (
                                    data.entry[0].resource.meta.lastUpdated.toString() ==
                                    prevdate
                                ) {
                                    return null;
                                }
                ...
                getDataForGraph(1, currentDate + "T00:00:00Z").then(
                    (result: any) => {
        ...
        if (observation[1]?.resource?.component?.length > 1) {
            ...
            setTimes(
                observation.map((obs) => {
                    ...
                    observation[1].resource.component.map((data, index) => {
                        if (
                            data.valueQuantity.unit.toString() == "C" ||
                            data.valueQuantity.unit.toString() == "C°" ||
                            data.valueQuantity.unit.toString() == "C°" ||
                            data.code.text.toString() == "Set Heater" ||
                            data.code.text.toString() == "Heater Level"
                        ) {
                            let unit =
                                data.valueQuantity.unit.toString() as keyof typeof heaterYaxis;
                            zeroth.push({
                                label: data.code.text.toString(),
                                data: observation.map((data2) => {
                                    if (data2?.resource?.component) {
                                        return data2?.resource?.component[
                                            index
                            ...
                            data.code.text.toString() == "Pulse Rate" ||
                            data.code.text.toString() == "SpO2" ||
                            data.code.text.toString() == "SPO2"
                        ) {
                            let unit2 =
                                data.valueQuantity.unit.toString() as keyof typeof pulseoximeterYaxis;
                            first.push({
                                label: data.code.text.toString(),
                                data: observation.map((data2) => {
                                    if (data2?.resource?.component) {
                            ...
                            data.valueQuantity.unit.toString() == "LPM" ||
                            data.code.text.toString() == "Set FiO2"
                        ) {
                            let unit =
                                data.valueQuantity.unit.toString() as keyof typeof pressure1OptionYaxis;
                            zeroth.push({
                                label: data.code.text.toString(),
                                data: observation.map((data2) => {
                                    if (data2?.resource?.component) {
                            ...
                            data.valueQuantity.unit.toString() == "CmH2O" ||
                            data.valueQuantity.unit.toString() == "Bar"
                        ) {
                            let unit =
                                data.valueQuantity.unit.toString() as keyof typeof pressure2OptionYaxis;
                            second.push({
                                label: data.code.text.toString(),
                                data: observation.map((data2) => {
                                    if (data2?.resource?.component) {
            ...
            setTimes(
                observation.map((obs) => {
                    ...
                    return new Date(
                        obs?.resource?.meta.lastUpdated.toString()
                    ).toLocaleTimeString();
                })
            );
        }
    ...
    const graph = useMemo(() => {
        if (
            props.observation_resource?.identifier[0]?.value?.toString() ==
            "PMS-CIC"
        ) {
            return (
                <Stack
                ...
                >
                    ...
                    >
                        ...
                        <Line
                            ref={chartRef2}
                            options={
                                pulseoximeterOption as ChartOptions<"line">
                            }
                        ...
                        <Line
                            ref={chartRef3}
                            options={weightOption as ChartOptions<"line">}
                            data={weightData}
                            height={"100%"}
                            plugins={[temperatureLegendPlugin]}
                        ></Line>
            ...
            return (
                ...
                >
                    ...
                    >
                        <Line
                            ref={chartRef1}
                            options={pressure1Option as ChartOptions<"line">}
                            data={temperatureData}
                            height={"100%"}
                            plugins={[temperatureLegendPlugin]}
                        ></Line>
                        ...
                        <Line
                            ref={chartRef3}
                            options={pressure2Option as ChartOptions<"line">}
                            data={weightData}
                            height={"100%"}
                            plugins={[temperatureLegendPlugin]}
                        ></Line>
        ...
        <React.Fragment>
            <Box
                sx={{
                    ...
                    backgroundImage:
                        "linear-gradient(to bottom, #111522, #111522, #111522)",
                    color: "#FFFFFF",
                    // height: "100vw", // Full screen width
                    // overflow: "auto", // Enables scrolling for overflow content
                    // // Additional styles to ensure it fits well, including handling mobile viewports
                    // maxWidth: "100%", // Ensures it does not exceed the viewport in mobile browsers
                    // boxSizing: "border-box", // Ensures padding and borders are included in width calculation
                }}
            >
                {/* <Dialog
                ...
                >
                    <Stack alignItems={"center"} spacing={"10px"}>
                        <Typography variant="subtitle1">
                            {props.newData &&
                                props.observation_resource?.component[0]?.code
                                    .text}
                        </Typography>
                        <Typography variant="h4" sx={{ fontWeight: "bold" }}>
                            {(() => {
                                if (props.newData) {
                                    return (
                                        props.observation_resource?.component[0]
                    ...
                    {props.newData &&
                        props.observation_resource?.component.map(
                            (_obs: any, index: number) => {
                                if (
                                    props.observation_resource?.component[index]
                                        ?.code.text != "SIQ" &&
                                    props.observation_resource?.component[index]
                                        ?.code.text != "PVI" &&
                                    props.observation_resource?.component[index]
                ...
                {props.newData && <Divider sx={{ marginTop: "20px" }} />}
                ...
                {props.newData ? (
                    ...
                    >
                        ...
                        >
                            {props.newData && "Oximeter Not connected"}
                            {!props.newData && ""}
                        </Typography>
                    </Box>
                )}
                            ...
                            <>
                                ...
                                >
                                            ...
                                            >
                                                <ToggleButton
                                                    ...
                                                    onClick={() => {
                                                        setS_and_D(0);
                                                        let temp: any[] = [];
                                                        chartRef1.current.data.datasets.forEach(
                                                            (
                                                                dataset: {
                                                                    label: any;
                                                                },
                                                                ...
                                                                chartRef1.current.setDatasetVisibility(
                                                                    datasetIndex,
                                                                    true
                                                                );
                                                            }
                                                        ...
                                                        chartRef2.current.data.datasets.forEach(
                                                            (
                                                                dataset: {
                                                                    label: any;
                                                                },
                                                                ...
                                                                chartRef2.current.setDatasetVisibility(
                                                                    datasetIndex,
                                                                    true
                                                                );
                                                            }
                                                        ...
                                                        chartRef3.current.data.datasets.forEach(
                                                            (
                                                                dataset: {
                                                                    label: any;
                                                                },
                                                                ...
                                                                chartRef3.current.setDatasetVisibility(
                                                                    datasetIndex,
                                                                    true
                                                                );
                                                            }
                                    ...
                                    <Dialog
                                        ...
                                        }} // borderRadius:'3%', boxShadow: `0px 0px 20px 10px #7B7B7B`, border:'1px solid #7B7B7B
                                    >
                                        <DialogTitle
                ...
                <Typography variant="h5" paddingLeft={"2%"} paddingTop={"3%"}>
                    Alarms
                </Typography>
                <Stack
                    direction={"row"}
                ...
                >
                    ...
                    <IconButton
                        ...
                        onClick={() => {
                            if (selectAlarm < newalarm.length) {
                                setSelectAlarm(selectAlarm + 1);
                            }
                        }}
                    >
                ...
                <Button
                    sx={{
                        ...
                        fontWeight: 50,
                        boxShadow: `0px 0px 10px 1px #6e6f88`,
                        textTransform: "capitalize",
                    }}
                    endIcon={
                        tableVisisble ? (
                            <KeyboardArrowUpIcon sx={{ fontSize: 80 }} />
                        ) : (
                    ...
                    onClick={() => {
                        handleClick();
                        setTableVisible(!tableVisisble);
                    }}
                >
                    <Box sx={{ fontWeight: "regular", m: 1, fontSize: 16 }}>
                        Alarm Log
                    </Box>
                </Button>
                <div
