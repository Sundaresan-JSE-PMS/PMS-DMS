...
//             location: vvtemp
//         }
//         //console.log(`http://3.110.169.17:9444/fhir-server/api/v4/Device/${deviceList[Number(index)].resource.id}`)
...
//         // let deviceList: any[] = []
//         useEffect(() =>{
//             fetch(`http://3.110.169.17:9444/fhir-server/api/v4/Device`, {
//           credentials: "omit",
//           headers: {
//             Authorization: "Basic "+ btoa("fhiruser:change-password"),
//           },
