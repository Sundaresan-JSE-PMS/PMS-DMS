                    ...
                    <Stack width={"100%"} height={'40%'} direction={'row'}>
                        ...
                        <Box width={'37.5%'} height={'100%'} sx={{ borderRight:'3px solid grey', borderTop:'3px solid grey'}} justifyContent={'center'} textAlign={'center'}>
                            ...
                            <div style={{display:'flex', textAlign:'center', justifyContent:'center'}}>
                                ...
                                <Typography variant='h6' color={"#26C5E4"} paddingLeft={'3%'}>
                                    {(() => {
                                        if(props.observation_resource?.component[0].valueQuantity.unit=="AIR"){
                        ...
                        <Box width={'25%'} height={'100%'} justifyContent={'center'} textAlign={'center'}>
                            ...
                            <Box display={'flex'} justifyContent={'space-around'} width={"100%"} height={"33%"} sx={{ borderTop:'3px solid grey'}}>
                                <Typography variant='subtitle2' color={"#A8C5D4"} marginTop={'10px'} paddingTop={'5%'}>O2 %</Typography>
                                <Typography variant='h5' color={"#26C5E4"} paddingTop={'2%'}>
                                    {(() => {
                            ...
                            <Box display={'flex'} justifyContent={'space-around'} width={"100%"} height={"34%"} sx={{ borderTop:'3px solid grey'}}>
                                <Typography variant='subtitle2' color={"#A8C5D4"} marginTop={'10px'} paddingTop={'3%'}>Weight (g)</Typography>
                                <Typography variant='h5' color={"#26C5E4"} paddingTop={'1%'}>
                                    {(() => {
                    ...
                    <Stack width={"100%"} height={'48%'} direction={'row'}>
                        ...
                        <Box width={'25%'} height={'100%'} >
                            <Box display={'flex'} width={'100%'} height={'33%'} sx={{ borderTop:'3px solid grey'}} justifyContent={'space-around'} textAlign={'center'}>
                                ...
                                <Typography variant='subtitle2' color={"#A8C5D4"}  paddingTop={'7%'}>PVI</Typography>
                                <Typography variant='h5' color={"#26C5E4"}  paddingTop={'2%'}>
                                    {(() => {
                            ...
                            <Box display={'flex'} width={'100%'} height={'33%'} sx={{ borderTop:'3px solid grey'}} justifyContent={'space-around'} textAlign={'center'}>
                                <Typography variant='subtitle2' color={"#A8C5D4"}  paddingTop={'7%'}>PI</Typography>
                                <Typography variant='h5' color={"#26C5E4"} paddingTop={'2%'}>
                                    {(() => {
                            ...
                            <Box display={'flex'} width={'100%'} height={'34%'} sx={{ borderTop:'3px solid grey'}} justifyContent={'space-around'} textAlign={'center'}>
                                <Typography variant='subtitle2' color={"#A8C5D4"} paddingTop={'5%'}>SIQ</Typography>
