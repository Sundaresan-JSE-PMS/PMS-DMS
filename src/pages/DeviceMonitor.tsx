    ...
    return (
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
          <Box
              ...
              >
                {/* <Typography variant='h3' color={'white'} letterSpacing={'.3rem'} flexGrow={1}>Device Monitor</Typography> */}
                {isAuthenticated && (
                  <Box sx={{width:"100%"}}>
                  ...
                  <Accordion elevation={0} defaultExpanded={true} sx={{backgroundColor:"transparent", backgroundImage:'none' ,marginBottom:"10px", borderBottom:'2px solid #00B1FD', borderTop:'none', '&:before': {opacity: 0}}}>
                    ...
                    >
                      <Typography variant='h5' component={"h2"} sx={{color:"#00B1FD"}}>Syringe Pumps</Typography>
                    </AccordionSummary>
                    <AccordionDetails>
                      <Box
                        sx={{
