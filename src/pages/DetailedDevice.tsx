...
//         fetch(`http://pmscloud.in:9444/fhir-server/api/v4/Communication/${communication_resource.id}/_history`, {
//           credentials: "omit",
//           headers: {
...
//                 fetch(`http://pmscloud.in:9444/fhir-server/api/v4/Communication/${communication_resource.id}/_history?_page=${page}&_count=100`,{
//                     credentials: "omit",
//                     headers: {
//                         Authorization: "Basic "+ btoa("fhiruser:change-password"),
//                     },
...
//         if(timeFrame==0){
//             url.push(`http://pmscloud.in:9444/fhir-server/api/v4/Observation/${observation_resource?.id}/_history?_since=${currentDate}T00:00:00Z&_count=10000`)
//         }
//         else if(timeFrame==1){
...
//                     url.push(`http://pmscloud.in:9444/fhir-server/api/v4/Observation/${observation_resource?.id}/_history?_count=1&_since=${weekDate}T${index2.toString().padStart(2,'0')}:00:00Z`)
//                 }
...
//                 url.push(`http://pmscloud.in:9444/fhir-server/api/v4/Observation/${observation_resource?.id}/_history?_count=1&_since=${monthDate}T00:00:00Z`)
//             }
//         }
//         let temparr: any[] = []
//         let prevdate = ""
...
//                     // }
//                     // while(totaldata>=100){
//                     //     fetch(`http://pmscloud.in:9444/fhir-server/api/v4/Observation/${observation_resource.id}/_history?_page=${page}&_count=100`,{
//                     //         credentials: "omit",
//                     //         headers: {
//                     //             Authorization: "Basic "+ btoa("fhiruser:change-password"),
//                     //         },
